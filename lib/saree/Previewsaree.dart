...
class Preview_saree extends StatefulWidget {
  @override
  Preview_sareeState createState() => Preview_sareeState();
}

class Preview_sareeState extends State<Preview_saree> {dynamic status = [true, true, true, true];
