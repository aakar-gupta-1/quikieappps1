...
class _HomePageScreenState extends State<HomePageScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    'Today',
    style: TextStyle(fontSize: 21.0, fontFamily: 'Productsans',fontWeight: FontWeight.bold, color: Color.fromRGBO(3,49,119,10),),
    textAlign: TextAlign.center,
        ...
        child:Text(
          'Orders',
          style: TextStyle(fontSize: 10.0, fontFamily: 'Productsans',fontWeight: FontWeight.bold, color: Color.fromRGBO(3,49,119,10),),
     ...
     Expanded(child:Padding(
        ...
        child:Text(
          '    Orders to Deliver',
          style: TextStyle(fontSize: 15.0, fontFamily: 'Productsans',fontWeight: FontWeight.bold, color: Color.fromRGBO(3,49,119,10),),
      ...
      Expanded(flex:7,child: Align(
        ...
        child: Image.asset("assets/images/Background Design.png")
        ))],
    ),
    ),
      ...
      Container(child:Stack(
        ...
        child: Row(children:[
          ...
          Padding(padding:EdgeInsets.only(left: 180.0),
              child:Text(
              'View All',
              style: TextStyle(fontSize: 16.0, fontFamily: 'Productsans',fontWeight: FontWeight.bold, color: Color.fromRGBO(3,49,119,10),),
